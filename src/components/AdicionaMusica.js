        ...
        <>
            <Dialog open={dialog}>
                ...
                <DialogContent style={{ textAlign: 'center' }}>
                    ...
                    <TextField onChange={handleEditDataSong} name="title" style={{ marginTop: '10px' }} variant="outlined" value={song.title} label="Nome da Música" fullWidth />
                    <TextField onChange={handleEditDataSong} style={{ marginTop: '10px' }} name="artist" variant="outlined" value={song.artist} label="Nome do Artista" fullWidth />
                    <TextField onChange={handleEditDataSong} style={{ marginTop: '10px' }} name="thumbnail" variant="outlined" value={song.thumbnail} label="Imagem" fullWidth />
                </DialogContent>
                <DialogActions>
                    <Button variant='outlined' onClick={() => setDialog(false)} color="secondary">Cancelar</Button>
                    <Button onClick={handleAddSong}variant='contained' color="secondary">Salvar</Button>
                </DialogActions>
            </Dialog>
